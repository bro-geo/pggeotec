...
<p>GDE Matviews Extension (Optional): "pggeotec_matviews.control" and "pggeotec_matviews--1.0.sql</p>
<h3> Documentation </h3>
...
<ul>
  <li> To be able to run the CREATE EXTENSION pggeotec command in your database, you need two download these files:<b>pggeotec--1.0.sql</b> and <b>pggeotec.control</b> and paste in <b> C:\Program Files\PostgreSQL\[VERSION]share\extension </b> </li> 
